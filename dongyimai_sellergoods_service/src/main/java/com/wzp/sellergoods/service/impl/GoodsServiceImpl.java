...
import com.wzp.mapper.*;
import com.wzp.pojo.*;
import com.wzp.pojo.TbGoodsExample.Criteria;
...
public class GoodsServiceImpl implements GoodsService {
    ...
    public void add(Goods goods) {
        ...
        this.saveItemList(goods);//插入商品SKU列表数据
    }
...
//修改dongyimai-sellergoods-service的GoodsServiceImpl ,将SKU列表插入的代码提取出来，封装到私有方法中
    /**
     * 插入SKU列表数据
     * @param goods
     */
...
//将原来的模糊匹配修改为精确匹配
            ...
            //查询非删除状态的数据
                criteria.andIsDeleteIsNull();//非删除状态,数据库中is_Delete值为null的
